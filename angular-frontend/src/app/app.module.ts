...
import { TestitemComponent } from './components/testitem/testitem.component';
import { TestitemAddComponent } from './components/testitem/testitem-add/testitem-add.component';
import { TestitemDetailsComponent } from './components/testitem/testitem-details/testitem-details.component';
import { TestitemListComponent } from './components/testitem/testitem-list/testitem-list.component';
...
@NgModule({
  declarations: [
    ...
    MedicineComponent,
    TestitemAddComponent,
    TestitemDetailsComponent,
  ...
  providers: [ DoctorService, PatientService, ReportService, MedicineService, TestitemService, DatePipe ],
